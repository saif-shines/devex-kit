...
One table for humans. There is no per-skill page.
...
| [freecodecamp-style](../plugins/documentation/skills/freecodecamp-style/SKILL.md) | documentation | `/freecodecamp-style` | Apply freeCodeCamp publication style. |
| [sdk-craft](../plugins/tooling/skills/sdk-craft/SKILL.md) | tooling | `/sdk-craft` | Design, build, and ship SDKs. |
| [devrel-tooling](../plugins/tooling/skills/devrel-tooling/SKILL.md) | tooling | `/devrel-tooling` | Build CLIs and API collections. |
